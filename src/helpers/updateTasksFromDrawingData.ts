...
function updateFinishes ( tasks, drawingData: DrawingData, levelsMap, levels ) {
...

  {
    ...
    parent:`L${level}RFIN`
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}WF`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}`,
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}ID`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}MEPFF`,
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}EL`,`${level}FIN${index}FF`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}EL`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}LF`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
      ...
      { id: `GWFI11{level}${index}`, resource: 'Sft2GraniteKCtop40sft', description: 'Kitchen Countertop L-Shape', length: 0.92, breadth: 2.13, area: 0, rate: KCtop40sftRates.Granite.Sft2, units: 'Unit', quantity: 1, totalCost: 0 },        
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}CT`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
      resources: [
      { id: `GFI13{level}${index}`, resource: 'UnitUPVCSlidDoor', description: 'Slide-Door', length: 0.92, breadth: 2.13, area: 0,  rate: DoorRates.UPVCSlid.Unit, units: 'Unit', quantity: 1, totalCost: 0 },        
      ], 
	    },
  	  {
	    id:`${level}FIN${index}JY`,
	    name:'Joinery',
	    start:'',
	    end:'',
	    duration:4,
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}EL`,`${level}FIN${index}SD`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
      resources: [
      { id: `GFI15{level}${index}`, resource: 'Sqm2PlyWCabinet', description: 'Cabinet', length: 2.5, breadth: 2.13, area: 0,  rate: CabinetRates.PlyW.Sqm2, units: 'Sqm', quantity: 1, totalCost: 0 },        
      ], 
	    },
	    {
	    id:`${level}FIN${index}EX`,
	    ...
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}JY`,`${level}FIN${index}FF`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
      resources: [
      { id: `GFI16{level}${index}`, resource: 'Unit2KitchenExhaust', description: 'Exhaust', rate: ExhaustRates.Kitchen.Unit2, units: 'Unit', quantity: 1, totalCost: 0 },        
      ], 
	    },
	    {
	    id:`${level}FIN${index}FR`,
	    name:'Furniture',
	    start:'',
	    end:'',
	    duration:15,
	    cost:0,
	    strategy:'FS',
	    dependencies:[`${level}FIN${index}JY`,`L${level}FLR${index}`],
	    type:'task',
	    progress:0,
	    hideChildren:false,
	    parent:`${level}FIN${index}FXT`,
      resources: [
      { id: `GFI17{level}${index}`, resource: 'Sqm2FurniFurnish', description: 'Furniture', length: 2, breadth: 2.5, area: 0,  rate: FurnishRates.Furni.Sqm3, units: 'Sqm', quantity: 1, totalCost: 0 },        
      ], 
	    },
    )
